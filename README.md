...
Enterprise Voting Node.js React MongoDB Docker Socket.io

A full-stack, real-time, secure online voting platform built with Node.js, React, and MongoDB.

🌐 Live Demo → https://voting-app-ixar.onrender.com
✨ Features
👤 Voter Features
...
Connect your GitHub repository (VikasSingh2011/VotingAPP1)
Add the environment variable: MONGODB_URI → your MongoDB Atlas connection string
Click Apply — Render handles everything else automatically!
MongoDB Atlas Setup:
Create a free cluster at MongoDB Atlas
Create a database user with a strong password
Go to Network Access → Add IP Address → Allow Access from Anywhere (0.0.0.0/0)
Copy the connection string (format: mongodb+srv://user:password@cluster.mongodb.net/voting)
Set it as MONGODB_URI in Render's Environment settings
👥 User Roles
...
👨‍💻 Developer
Vikas Singh 🔗 GitHub: @VikasSingh2011 📧 Email: singhvikas1004@gmail.com
